...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-exporter-prometheus-remote-write-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-exporter-prometheus-remote-write-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-exporter-prometheus-remote-write
# for installing globally
pixi global install opentelemetry-exporter-prometheus-remote-write
```
...
It is possible to list all of the versions of `opentelemetry-exporter-prometheus-remote-write` available on your platform:
...
```
pixi search opentelemetry-exporter-prometheus-remote-write --channel conda-forge
```
